...
namespace winrt::UWPTiles::implementation
{
    ...
    App::App()
    {
        ...
        UnhandledException([this](winrt::Windows::Foundation::IInspectable const&, auto const& e)
            {
    ...
    void App::OnLaunched(Windows::ApplicationModel::Activation::LaunchActivatedEventArgs const& e)
    {
        ...
        if (rootFrame == nullptr)
        {
            ...
            rootFrame = winrt::Windows::UI::Xaml::Controls::Frame();
            ...
            if (e.PrelaunchActivated() == false)
            {
                if (rootFrame.Content() == nullptr)
                {
                    ...
                    // parameter
                    rootFrame.Navigate(xaml_typename<UWPTiles::MainPage>(), box_value(e.Arguments()));
                }
                // Place the frame in the current Window
                winrt::Windows::UI::Xaml::Window::Current().Content(rootFrame);
    ...
    void App::OnNavigationFailed(IInspectable const&, Windows::UI::Xaml::Navigation::NavigationFailedEventArgs const& e)
    {
